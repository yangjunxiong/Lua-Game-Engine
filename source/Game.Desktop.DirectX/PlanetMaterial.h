...
class PlanetMaterial : public GameEngine::Material
{
	RTTI_DECLARATIONS(PlanetMaterial, Material);

public:
	PlanetMaterial(GameEngine::Game& game);
	PlanetMaterial(const PlanetMaterial&) = default;
	PlanetMaterial& operator=(const PlanetMaterial&) = default;
	PlanetMaterial(PlanetMaterial&&) = default;
	PlanetMaterial& operator=(PlanetMaterial&&) = default;
	virtual ~PlanetMaterial() = default;
