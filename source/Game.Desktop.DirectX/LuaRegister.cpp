...
DECLARE_LUA_WRAPPER(StaticMeshMaterial, "StaticMeshMaterial");
LUA_DEFINE_CUSTOM_OBJECT_TYPE(StaticMeshMaterial);
DECLARE_LUA_WRAPPER(StaticMeshRenderComponent, "StaticMeshRenderComponent");
...
DECLARE_LUA_WRAPPER(Quaternion, "Quaternion");
...
DECLARE_LUA_WRAPPER(Vector4, "Vector4");
LUA_DEFINE_CUSTOM_OBJECT_TYPE(Vector4);
DECLARE_LUA_WRAPPER(Vector3, "Vector3");
